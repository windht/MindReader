...
EPUBJS.Book.prototype.nextPage = function(deferred){
	var next;
  var defer = deferred || new RSVP.defer();

	if(!this.isRendered) {
    this._q.enqueue("nextPage", arguments);
    defer.reject();
  };
...
EPUBJS.Book.prototype.prevPage = function(deferred) {
	var prev;
  var defer = deferred || new RSVP.defer();

	if(!this.isRendered) {
    this._q.enqueue("prevPage", arguments);
    defer.reject()
  }
